...
1. Haversine-etäisyyslaskenta
1. Etäisyysbonus AREAS-pisteisiin
1. Suuntadetektio (lähestytäänkö kaupunkia?)
1. TrainAgent-erikoislogiikka (Tikkurila vs HKI)
...
```
    ...
    if loc is None:
        st.markdown(
            ...
            '<span style="color:#888899">o</span> GPS ei saatavilla</div>',
